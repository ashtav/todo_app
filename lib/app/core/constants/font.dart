...
TextStyle gfont = GoogleFonts.nunitoSans(fontSize: 15.5, color: Colors.black);
...
class Gfont {
  // font color
  static final TextStyle black = gfont.copyWith(color: Colors.black);
  static final TextStyle white = gfont.copyWith(color: Colors.white);
  static final TextStyle red = gfont.copyWith(color: Colors.red);
  static final TextStyle orange = gfont.copyWith(color: Colors.orange);
  static final TextStyle blue = gfont.copyWith(color: Colors.blue);
  static final TextStyle green = gfont.copyWith(color: Colors.green);
  static final TextStyle grey = gfont.copyWith(color: Colors.grey);
